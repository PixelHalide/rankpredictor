  ...
  return (
    <div className="min-h-screen bg-slate-950/90 px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto w-full max-w-2xl">
        <div className="mb-8 border-4 border-slate-600 bg-slate-950 p-6 shadow-[8px_8px_0px_#64748b] sm:p-8">
          <h1 className="text-4xl font-bold uppercase tracking-tighter sm:text-5xl">
            <span className="bg-emerald-400 px-2 py-1 text-slate-950">MIT</span>{" "}
            GPA Calculator
          </h1>
        ...
        <div className="mb-12 w-full border-4 border-slate-600 bg-slate-950 p-6 shadow-[12px_12px_0px_#64748b] md:p-10">
          <label className="mb-4 block text-lg font-bold uppercase tracking-widest text-white md:text-xl">
