  ...
  return (
    <div>
          <header className="relative flex items-center justify-center mb-5 mt-6">
            <img src="/logo.png" alt="Company Logo" className="sm:hidden absolute top-2 left-5 w-16 md:w-20 cursor-pointer" />
        ...
        <nav className="flex flex-col md:flex-row justify-center gap-8 mb-5 text-center">
            ...
            <Link href="/met2024" className="text-lg border border-white py-1 px-4 rounded hover:text-yellow-500 hover:border-yellow-500 transition-all">
            MET 2024 Rank
            </Link>
