    ...
    <div className="content mb-8 max-w-4xl mx-auto">
      ...
      {isOpen && (
        <div className="bg-gray-900 rounded-lg p-6">
          ...
          <p className="mb-4">Your final band score is calculated using the following formula:</p>
          ...
          <p className="mb-4">
            Where M is your MET score (out of 240), and B is your board band (0-10).<br />
          ...
          <p className="mb-4">
            ...
            </a>, we can find the ranks for values of various band scores.
          </p>

          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-4">FAQs for the Rank Predictor</h3>
            <div className="space-y-6 text-base leading-relaxed">
              <div>
                ...
                <ul className="list-disc list-inside ml-4 mt-2 mb-2 text-gray-300 space-y-1">
                  <li>
                    For the MET 2024 Rank Predictor, I used just 10 data points from the 2020 results. After the actual results were out, the average error was{' '}
                    <span className="font-semibold text-yellow-300">+1.5k</span> (meaning the predictor showed a lower rank than people actually got).
                  </li>
                </ul>
                <p className="font-semibold mt-2 mb-2">Possible sources of inaccuracy:</p>
