        ...
        <div className="border-4 border-t-0 border-white bg-black p-6 text-white space-y-6">
          <div>
            <h3 className="font-bold uppercase tracking-widest text-sm mb-3">
              <span className="bg-white text-black px-2 py-1">Grade Point Scale</span>
            </h3>
          ...
          <div>
            <h3 className="font-bold uppercase tracking-widest text-sm mb-3">
              <span className="bg-white text-black px-2 py-1">GPA Calculation</span>
            </h3>
            <p className="text-gray-300 font-bold leading-relaxed mb-3">
              Your Grade Point Average (GPA) is calculated using the following formula:
            </p>
            <div className="border-2 border-white p-4 text-center font-mono font-bold text-lg">
          ...
          <div>
            <h3 className="font-bold uppercase tracking-widest text-sm mb-3">
              <span className="bg-white text-black px-2 py-1">Grade Determination</span>
            </h3>
            <p className="text-gray-300 font-bold leading-relaxed mb-3">
              Professors assign grades based on class average and standard deviation.
            </p>
            <div className="space-y-3 text-sm font-bold text-gray-300">
              <div className="border-2 border-white p-3">
                <p className="text-white mb-1">Maximum Cutoffs (when average/std dev is high):</p>
                <p>A+: 90 &nbsp; A: 82 &nbsp; B: 74 &nbsp; C: 66 &nbsp; D: 58 &nbsp; E: 50</p>
              </div>
              <div className="border-2 border-white p-3">
                <p className="text-white mb-1">Minimum Cutoffs (when scores are low):</p>
                <p>A+: 75 &nbsp; A: 67 &nbsp; B: 59 &nbsp; C: 51 &nbsp; D: 43 &nbsp; E: 35</p>
              </div>
              <div className="border-2 border-white p-3">
                <p className="text-white mb-1">Lab Subjects (always absolute):</p>
                <p>A+: 90 &nbsp; A: 80 &nbsp; B: 70 &nbsp; C: 60 &nbsp; D: 50 &nbsp; E: 40</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="font-bold uppercase tracking-widest text-sm mb-3">
              <span className="bg-white text-black px-2 py-1">Assessment Breakdown</span>
            </h3>
            <ul className="space-y-1 font-bold text-sm text-gray-300 border-2 border-white p-4">
          ...
          <div>
            <h3 className="font-bold uppercase tracking-widest text-sm mb-3">
              <span className="bg-white text-black px-2 py-1">Grade Cutoff Calculator</span>
            </h3>
