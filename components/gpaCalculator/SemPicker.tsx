  ...
  return (
    ...
    >
      <div className="grid grid-cols-4 grid-rows-2 gap-3 text-center w-full">
        <span onClick={() => sendSemester(1)} className={getClasses(1)}>I</span>
        <div onClick={() => sendSemester(2)} className={getClasses(2)}>II</div>
        <div onClick={() => sendSemester(3)} className={getClasses(3)}>III</div>
        <div onClick={() => sendSemester(4)} className={getClasses(4)}>IV</div>
        <div onClick={() => sendSemester(5)} className={getClasses(5)}>V</div>
        <div onClick={() => sendSemester(6)} className={getClasses(6)}>VI</div>
        <div onClick={() => sendSemester(7)} className={getClasses(7)}>VII</div>
        <div onClick={() => sendSemester(8)} className={getClasses(8)}>VIII</div>
      </div>
    </div>
  )
}
